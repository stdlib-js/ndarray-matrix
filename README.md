...
```javascript
ns = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-matrix@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var ns = require( 'path/to/vendor/umd/ndarray-matrix/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-matrix@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/ndarray-matrix.svg
[npm-url]: https://npmjs.org/package/@stdlib/ndarray-matrix

[test-image]: https://github.com/stdlib-js/ndarray-matrix/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/ndarray-matrix/actions/workflows/test.yml?query=branch:main

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/ndarray-matrix/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/ndarray-matrix?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/ndarray-matrix.svg
[dependencies-url]: https://david-dm.org/stdlib-js/ndarray-matrix/main
...
[deno-url]: https://github.com/stdlib-js/ndarray-matrix/tree/deno
[deno-readme]: https://github.com/stdlib-js/ndarray-matrix/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/ndarray-matrix/tree/umd
[umd-readme]: https://github.com/stdlib-js/ndarray-matrix/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/ndarray-matrix/tree/esm
[esm-readme]: https://github.com/stdlib-js/ndarray-matrix/blob/esm/README.md
